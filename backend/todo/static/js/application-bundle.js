...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todoComponentsJsx = __webpack_require__(159);
	
	var _todoComponentsJsx2 = _interopRequireDefault(_todoComponentsJsx);
	...
	_reactReact2['default'].render(_reactReact2['default'].createElement(_todoComponentsJsx2['default'], null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsJs = __webpack_require__(160);
	
	var _componentsJs2 = _interopRequireDefault(_componentsJs);
	
	var _dispatchersJs = __webpack_require__(161);
	
	var _dispatchersJs2 = _interopRequireDefault(_dispatchersJs);
	
	var _storesJs = __webpack_require__(165);
	...
	var TodoBox = (function (_BaseComponent) {
	    _inherits(TodoBox, _BaseComponent);
	    ...
	    _createClass(TodoBox, [{
	        ...
	        value: function componentDidMount() {
	            _storesJs2['default'].on('add remove', this.onChange);
	            _storesJs2['default'].fetch();
	        }
	    }, {
	        ...
	        value: function onChange() {
	            ...
	            this.setState({ todos: _storesJs2['default'].models });
	        }
	    }, {
	        key: 'render',
	    ...
	    return TodoBox;
	})(_componentsJs2['default']);
	
	var TodoList = (function (_BaseComponent2) {
	    _inherits(TodoList, _BaseComponent2);
	        ...
	        value: function render() {
	            ...
	            try {
	                for (var _iterator = this.props.todos[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    todoItems.push(_reactReact2['default'].createElement(TodoItem, { key: todo.cid, todo: todo }));
	                }
	            } catch (err) {
	...
	var TodoItem = (function (_BaseComponent3) {
	    _inherits(TodoItem, _BaseComponent3);
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function render() {
	            ...
	            return _reactReact2['default'].createElement(
	                'li',
	                { className: todo.get('completed') ? 'bg-success complete' : '' },
	                _reactReact2['default'].createElement(
	                    'div',
	                    { className: 'todo-item' },
	...
	var TodoItemCheck = (function (_BaseComponent4) {
	    _inherits(TodoItemCheck, _BaseComponent4);
	
	    function TodoItemCheck() {
	        _classCallCheck(this, TodoItemCheck);
	
	        _get(Object.getPrototypeOf(TodoItemCheck.prototype), 'constructor', this).apply(this, arguments);
	    }
	...
	var TodoItemLabel = (function (_BaseComponent5) {
	    _inherits(TodoItemLabel, _BaseComponent5);
	    ...
	    _createClass(TodoItemLabel, [{
	        ...
	        value: function cancelEditing() {
	            ...
	            _reactReact2['default'].findDOMNode(this.refs.label).value = this.props.todo.get('label');
	            this.stopEditing();
	        }
	    }, {
	        key: 'onBlur',
	...
	var TodoItemRemove = (function (_BaseComponent6) {
	    _inherits(TodoItemRemove, _BaseComponent6);
	
	    function TodoItemRemove() {
	        _classCallCheck(this, TodoItemRemove);
	
	        _get(Object.getPrototypeOf(TodoItemRemove.prototype), 'constructor', this).apply(this, arguments);
	    }
	...
	var TodoForm = (function (_BaseComponent7) {
	    _inherits(TodoForm, _BaseComponent7);
	    ...
	    _createClass(BaseComponent, [{
	        ...
	        value: function _bindMethods() {
	            ...
	            props = props.filter(function (p) {
	                return typeof _this[p] === 'function';
	            });
	            var _iteratorNormalCompletion = true;
	            var _didIteratorError = false;
	            var _iteratorError = undefined;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Todo = _persistenceJs.Model.extend({ resource: 'todos' });
	var TodoCollection = _persistenceJs.Collection.extend({ model: Todo, resource: 'todos' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backboneBackbone = __webpack_require__(167);
	
	var _backboneBackbone2 = _interopRequireDefault(_backboneBackbone);
	
	var _promise = __webpack_require__(169);
	
	var _promise2 = _interopRequireDefault(_promise);
	
	var _apiJs = __webpack_require__(178);
	...
	function sync(method, model, options) {
	    ...
	    model.getEndpoint().then(function (endpoint) {
	        ...
	        _backboneBackbone2['default'].sync.apply(self, args);
	    });
	}
	
	var Model = _backboneBackbone2['default'].Model.extend({
	    sync: sync,
	    getEndpoint: function getEndpoint() {
	        if (this.isNew()) {
	            return (0, _apiJs.getResourceEndpoint)(this.resource);
	        }
	...
	exports.Model = Model;
	var Collection = _backboneBackbone2['default'].Collection.extend({
	    sync: sync,
	    getEndpoint: function getEndpoint() {
	        return (0, _apiJs.getResourceEndpoint)(this.resource);
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(168), __webpack_require__(1), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
