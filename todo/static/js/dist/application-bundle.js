...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsCookieSrcJsCookieJs = __webpack_require__(2);
	
	var _jsCookieSrcJsCookieJs2 = _interopRequireDefault(_jsCookieSrcJsCookieJs);
	
	var _reactReact = __webpack_require__(3);
	
	var _reactReact2 = _interopRequireDefault(_reactReact);
	
	var _todoComponentsJs = __webpack_require__(159);
	
	var _todoComponentsJs2 = _interopRequireDefault(_todoComponentsJs);
	
	_jquery2['default'].ajaxSetup({
	    headers: {
	        'X-CSRFToken': _jsCookieSrcJsCookieJs2['default'].get('csrftoken')
	    }
	});
	
	_reactReact2['default'].render(_reactReact2['default'].createElement(_todoComponentsJs2['default'], null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dispatchersJs = __webpack_require__(160);
	
	var _dispatchersJs2 = _interopRequireDefault(_dispatchersJs);
	
	var _storesJs = __webpack_require__(164);
	
	var _storesJs2 = _interopRequireDefault(_storesJs);
	
	var _actionsJs = __webpack_require__(168);
	...
	var TodoBox = (function (_React$Component) {
	    ...
	    function TodoBox(props) {
	        ...
	        _get(Object.getPrototypeOf(TodoBox.prototype), 'constructor', this).call(this, props);
	        this.state = { todos: [] };
	    ...
	    _createClass(TodoBox, [{
	        ...
	        value: function componentDidMount() {
	            _storesJs2['default'].bind('add', this.onChange);
	            _storesJs2['default'].bind('remove', this.onChange);
	            _storesJs2['default'].load();
	        }
	    }, {
	        key: 'componentWillUnmount',
	        value: function componentWillUnmount() {
	            _storesJs2['default'].unbind('add', this.onChange);
	            _storesJs2['default'].unbind('remove', this.onChange);
	        }
	    }, {
	        key: 'onChange',
	        value: function onChange() {
	            console.log('onChange');
	            this.setState({ todos: _storesJs2['default'].all() });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _reactReact2['default'].createElement(
	                ...
	                _reactReact2['default'].createElement(TodoForm, null),
	                _reactReact2['default'].createElement(TodoList, { todos: this.state.todos }),
	                _reactReact2['default'].createElement(
	                    'em',
	    ...
	    return TodoBox;
	})(_reactReact2['default'].Component);
	...
	var TodoItem = (function (_React$Component3) {
	    ...
	    _createClass(TodoItem, [{
	        ...
	        value: function onRemove(event) {
	            ...
	            event.preventDefault();
	            _actionsJs2['default'].remove(this.props.todo);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            return _reactReact2['default'].createElement(
	                'li',
	                { className: todo.attr('completed') ? 'bg-success complete' : '' },
	                _reactReact2['default'].createElement(
	                    'div',
	                    { className: 'todo-item' },
	                    _reactReact2['default'].createElement(TodoItemCheck, { todo: todo }),
	                    _reactReact2['default'].createElement(TodoItemLabel, { todo: todo }),
	                    _reactReact2['default'].createElement(TodoItemRemove, { todo: todo })
	                )
	            );
	        }
	    }]);
	...
	var TodoItemCheck = (function (_React$Component4) {
	    _inherits(TodoItemCheck, _React$Component4);
	
	    function TodoItemCheck(props) {
	        _classCallCheck(this, TodoItemCheck);
	
	        _get(Object.getPrototypeOf(TodoItemCheck.prototype), 'constructor', this).call(this, props);
	        this.onChange = this.onChange.bind(this);
	    }
	
	    _createClass(TodoItemCheck, [{
	        key: 'onChange',
	...
	var TodoItemLabel = (function (_React$Component5) {
	    _inherits(TodoItemLabel, _React$Component5);
	
	    function TodoItemLabel(props) {
	        _classCallCheck(this, TodoItemLabel);
	
	        _get(Object.getPrototypeOf(TodoItemLabel.prototype), 'constructor', this).call(this, props);
	    ...
	    _createClass(TodoItemLabel, [{
	        key: 'onSubmit',
	        value: function onSubmit(event) {
	            event.preventDefault();
	            var label = _reactReact2['default'].findDOMNode(this.refs.label).value.trim();
	            if (label && label != this.props.todo.attr('label')) {
	                _actionsJs2['default'].setLabel(this.props.todo, label);
	            }
	            this.stopEditing();
	        }
	    }, {
	        ...
	        value: function cancelEditing() {
	            ...
	            _reactReact2['default'].findDOMNode(this.refs.label).value = this.props.todo.attr('label');
	            this.stopEditing();
	        }
	    }, {
	        key: 'onBlur',
	            ...
	            return _reactReact2['default'].createElement(
	                ...
	                _reactReact2['default'].createElement(
	                    ...
	                    { style: { display: this.state.editing ? 'inline' : 'none' },
	                        autofocus: true, onSubmit: this.onSubmit, className: 'todo-label' },
	                    _reactReact2['default'].createElement('input', { onBlur: this.onBlur, onKeyDown: this.onKeyDown, ref: 'label',
	...
	var TodoItemRemove = (function (_React$Component6) {
	    _inherits(TodoItemRemove, _React$Component6);
	
	    function TodoItemRemove(props) {
	        _classCallCheck(this, TodoItemRemove);
	
	        _get(Object.getPrototypeOf(TodoItemRemove.prototype), 'constructor', this).call(this, props);
	        this.onClick = this.onClick.bind(this);
	    }
	
	    _createClass(TodoItemRemove, [{
	        key: 'onClick',
	...
	var TodoForm = (function (_React$Component7) {
	    _inherits(TodoForm, _React$Component7);
	    ...
	    _createClass(TodoForm, [{
	        ...
	        value: function handleSubmit(event) {
	            ...
	            var labelNode = _reactReact2['default'].findDOMNode(this.refs.label),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vendorJsModelJs = __webpack_require__(165);
	...
	var END_POINT = '/api/items';
	
	var Todo = (0, _vendorJsModelJs2['default'])('todo', function () {
	    this.persistence(_vendorJsModelJs2['default'].REST, END_POINT);
	});
...
/***/ function(module, exports) {
	...
	var Model = function Model(name, func) {
	  ...
	  model.collection = [];
	  model.unique_key = "id";
	  model.extend(Model.Callbacks).extend(Model.ClassMethods);
	...
	Model.ClassMethods = {
	  ...
	  persistence: function persistence(adapter) {
	  ...
	  pluck: function pluck(attribute) {
	    var all = this.all();
	    var plucked = [];
	  ...
	  select: function select(func, context) {
	    var all = this.all(),
	        selected = [],
	        model;
	  ...
	  sortBy: function sortBy(attribute_or_func) {
	    var is_func = Model.Utils.isFunction(attribute_or_func);
	    var extract = function extract(model) {
	...
	Model.InstanceMethods = {
	  ...
	  callPersistMethod: function callPersistMethod(method, callback) {
	    var self = this;
	
	    // Automatically manage adding and removing from the model's Collection.
	    var manageCollection = function manageCollection() {
	      if (method === "destroy") {
	    ...
	    var wrappedCallback = function wrappedCallback(success) {
	      if (success) {
	  ...
	  merge: function merge(attributes) {
	...
	Model.localStorage = function (klass) {
	  if (!window.localStorage) {
	    return {
	      ...
	      destroy: function destroy(model, callback) {
	        callback(true);
	      },
	      ...
	      update: function update(model, callback) {
	        callback(true);
	      }
	    };
	  }
	  ...
	  var readIndex = function readIndex() {
	    var data = localStorage[collection_uid];
	    return data ? JSON.parse(data) : [];
	  };
	  var writeIndex = function writeIndex(uids) {
	    localStorage.setItem(collection_uid, JSON.stringify(uids));
	  };
	  var addToIndex = function addToIndex(uid) {
	    var uids = readIndex();
	  ...
	  var removeFromIndex = function removeFromIndex(uid) {
	    var uids = readIndex();
	  ...
	  var store = function store(model) {
	  ...
	  return {
	    ...
	    read: function read(callback) {
	      ...
	      var existing_uids = klass.map(function () {
	        return this.uid;
	      });
	      var uids = readIndex();
	      var models = [];
	...
	Model.REST = function (klass, resource, methods) {
	  ...
	  return Model.Utils.extend({
	    ...
	    create_path: function create_path(model) {
	    ...
	    destroy_path: function destroy_path(model) {
	      return this.update_path(model);
	    },
	
	    params: function params(model) {
	      var params;
	      if (model) {
	    ...
	    update_path: function update_path(model) {
	      return [this.path(model), model.id()].join('/');
	    },
	
	    xhr: function xhr(method, url, model, callback) {
	      var self = this;
	    ...
	    xhrComplete: function xhrComplete(xhr, textStatus, model, callback) {
	...
	Model.REST.parseResponseData = function (xhr) {
	  try {
	    return (/\S/.test(xhr.responseText) ? jQuery.parseJSON(xhr.responseText) : undefined
	    );
	  } catch (e) {
	    Model.Log(e);
	  }
	...
	Model.Utils = {
	  ...
	  inArray: function inArray(array, obj) {
